...
<template>
    <footer>
        ...
        <div class="down-footer">
            <div class="container-center-down">
                <div id="sign-up">
                    SIGN-UP NOW!
                </div>
                <div id="down-list">
...
<style lang=scss scoped>
    ...
    .up-footer .container-center-up > ul{
        width: 100%;
        list-style: none;
        display: flex;
    ...
    .container-center-middle > div{
        margin-right: 20px;
    };

    .container-center-middle li{
        color: #7a8071;
        margin: 5px 0;
        list-style: none;
    };
    ...
    .container-center-down #down-list ul {
        display: flex;

    };

    .container-center-down #down-list ul > li {
        list-style: none;
        margin: 0 10px;
        height: 50px;
        min-width: 50px;
    ...
    .container-center-down #down-list #follow-us {
        color: #0282f9;
        font-weight: bold;
